 ...
 */
namespace Apexx\Afterpay\Model\Adminhtml\System\Config;
...
class CountryCreditCard extends Value
{
    ...
    public function beforeSave()
    {
        ...
        foreach ($value as $data) {
            if (empty($data['country_id']) || empty($data['account_id'])) {
                continue;
            }
            ...
            if (array_key_exists($country, $result)) {
                ...
                $result[$country] = $data['account_id'];
            }
        }
    ...
    protected function encodeArrayFieldValue(array $value)
    {
        ...
        foreach ($value as $country => $creditCardType) {
            ...
            $result[$id] = ['country_id' => $country, 'account_id' => $creditCardType];
        }
        return $result;
    }
