...
class RefundSale implements ClientInterface
{
    ...
    public function placeRequest(TransferInterface $transferObject)
    {
        ...
        // Set capture url
        $url = $this->apexxBaseHelper->getApiEndpoint().'refund/afterpay/'.$request['transactionId'];
        ...
        $this->customLogger->debug('Afterpay Refund Request:', $request);
        $this->customLogger->debug('Afterpay Refund Response:', $responseResult);
